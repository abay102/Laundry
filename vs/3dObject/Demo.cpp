...
void Demo::BuildColoredCube() {
	...
	float vertices[] = {
		...
		// front
		-0.5, -0.5, 0.5, 0.23, 0.17,  // 0
		0.5, -0.5, 0.5, 0.77, 0.17,   // 1
		0.5,  0.5, 0.5, 0.77, 0.87,   // 2
		-0.5,  0.5, 0.5, 0.23, 0.87,  // 3
		...
		// upper
		0.5, 0.5,  0.5, 0.23, 0.23,   // 16
		-0.5, 0.5,  0.5, 0.3, 0.23,  // 17
		-0.5, 0.5, -0.5, 0.3, 0.3,  // 18
		0.5, 0.5, -0.5, 0.23, 0.3,   // 19
